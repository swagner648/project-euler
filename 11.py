...
for x in range(0, 20):
    for y in range(0, 20):
        maxProduct = max(np.prod(north(grid, x, y)), maxProduct)
        maxProduct = max(np.prod(northEast(grid, x, y)), maxProduct)
        maxProduct = max(np.prod(east(grid, x, y)), maxProduct)
        maxProduct = max(np.prod(southEast(grid, x, y)), maxProduct)
